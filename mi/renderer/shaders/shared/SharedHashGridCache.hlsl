...
#define HASHGRIDS_TILE_CELL_WIDTH_L2 3 // log2(HASHGRIDS_TILE_CELL_WIDTH)
#define HASHGRIDS_TILE_CELL_INDEX_MASK (HASHGRIDS_TILE_CELL_WIDTH * HASHGRIDS_TILE_CELL_WIDTH - 1)
